...
const Form = styled.form`
  ${tw`flex w-96 flex-col items-center justify-center gap-4 rounded-lg bg-white px-8 py-12`}
  ...
  input {
    ${tw`w-full rounded-md border border-gray-300 px-4 py-2 outline-none`}
  }
...
const VerificationCodeBlock = styled.div`
  ...
  button {
    ${tw`w-1/5 rounded-md bg-black px-4 py-2 text-white`}
  }
`
